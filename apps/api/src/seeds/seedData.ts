...
export const seedData = {
  ...
  stories: [
    { title: 'The Student Who Turned a Problem Into a Solution', dek: 'Meet the young minds creating solutions for problems around them.', category: 'student', content: 'Every campus has that one student who cannot walk past a broken thing without stopping. This is a story about one of them.\n\nA prototype, a failed version, a better version — and a solution the people around them actually use.', image: '/images/stories/story-3.jpg', readingTime: 5, featured: true },
    ...
    { title: 'The Interview That Changed How I See Failure', dek: 'What a rejection call taught one student about starting again.', category: 'student', content: 'The rejection email was polite, brief and devastating. The feedback call that followed reframed everything.', image: '/images/stories/story-5.jpg', readingTime: 4 },
    { title: 'The Hostel Room Studio', dek: 'How three friends turned a hostel room into a production studio between classes.', category: 'startup', content: 'Two beds pushed aside, one borrowed mic, a blanket on the wall for sound damping — version one of the studio.', image: '/images/campaign/campaign-3.jpg', readingTime: 5 },
    { title: 'When a Class Project Became a Company', dek: 'A semester assignment, an understanding mentor, and twelve months of saying "what if".', category: 'startup', content: 'The brief was simple: propose a solution to a local problem. The company, as it turned out, was due a year later.', image: '/images/stories/story-6.jpg', readingTime: 5 },
    { title: 'The Library That Never Sleeps', dek: 'Open all night, powered by students — inside a campus reading-room movement.', category: 'campus', content: 'At 2 a.m., the reading room is fuller than most classrooms are at noon.', image: '/images/campus/campus-4.jpg', readingTime: 4 },
    { title: 'How One Club Turned a Quiet Campus Into a Stage', dek: 'Open mics, street theatre and a lot of courage.', category: 'campus', content: 'Then a handful of students asked a dangerous question: what if we used the auditorium every month?', image: '/images/events/event-3.jpg', readingTime: 4 },
  ],

  campuses: [
    { name: 'Vidya Vihar Central University', university: 'Vidya Vihar Central University', city: 'Pune', state: 'Maharashtra', type: 'Central University', description: 'A campus known for its student incubator, weekend makers meets and an active research circle.', image: '/images/campus/campus-1.jpg', categories: ['Campus News', 'Student Achievements', 'Campus Life'] },
    { name: 'Nalanda Institute of Technology', university: 'Nalanda Institute of Technology', city: 'Patna', state: 'Bihar', type: 'Technical Institute', description: 'An engineering campus with a thriving hackathon culture and a student-run night library.', image: '/images/campus/campus-2.jpg', categories: ['Campus Events', 'Clubs & Communities', 'Student Initiatives'] },
    ...
    { name: 'Himalayan Polytechnic & Research Institute', university: 'Himalayan Polytechnic & Research Institute', city: 'Dehradun', state: 'Uttarakhand', type: 'Polytechnic', description: 'A polytechnic campus where media, making and mountains meet.', image: '/images/campus/campus-5.jpg', categories: ['Clubs & Communities', 'Campus Events'] },
  ...
  podcasts: [
    { episodeNumber: 1, title: 'WE MET THESE LITTLE MONKS | RUMTEK MONASTERY - SIKKIM', description: 'In this episode of the All India Youth Career Awareness documentary series, The Student Chapters visits Rumtek Monastery in Sikkim. We meet young monks, explore their daily routine, education, spiritual discipline, and unique life journeys tucked high in the Eastern Himalayas.', guest: 'Young Monks & Teachers', guestRole: 'Rumtek Dharma Chakra Centre, Sikkim', category: 'Ideas & Perspectives', durationLabel: '24:15', durationSeconds: 1455, audioUrl: null, videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', youtubeUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', thumbnail: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', featured: true, publishedAt: '2026-08-25' },
    { episodeNumber: 2, title: 'The Gap Year That Changed Everything', description: 'A student voices episode on choosing an unconventional pause.', guest: 'Riya Chatterjee', guestRole: 'Student & writer', category: 'Student Voices', durationLabel: '31:40', durationSeconds: 1900, audioUrl: '/audio/tsc-placeholder-audio.wav', videoUrl: null, youtubeUrl: null, thumbnail: '/images/podcast/podcast-1.jpg', publishedAt: '2026-08-11' },
    { episodeNumber: 3, title: 'Breaking Into Tech Without a CS Degree', description: 'A career conversation about routes into technology careers.', guest: 'Aman Khanna', guestRole: 'Software engineer & mentor', category: 'Career Conversations', durationLabel: '44:05', durationSeconds: 2645, audioUrl: null, videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', youtubeUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', thumbnail: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', publishedAt: '2026-07-28' },
    { episodeNumber: 4, title: 'Ideas Are Cheap. Execution Is Everything.', description: 'An ideas & perspectives episode on what separates builders from planners.', guest: 'Dr. Nandita Rao', guestRole: 'Educator & researcher', category: 'Ideas & Perspectives', durationLabel: '29:58', durationSeconds: 1798, audioUrl: '/audio/tsc-placeholder-audio.wav', videoUrl: null, youtubeUrl: null, thumbnail: '/images/podcast/podcast-3.jpg', publishedAt: '2026-07-14' },
    { episodeNumber: 5, title: 'Studying Smart: Science Over Superstition', description: 'Evidence-based conversation about how students actually learn better.', guest: 'Vikram Shetty', guestRole: 'Learning researcher', category: 'Ideas & Perspectives', durationLabel: '36:22', durationSeconds: 2182, audioUrl: '/audio/tsc-placeholder-audio.wav', videoUrl: null, youtubeUrl: null, thumbnail: '/images/podcast/podcast-4.jpg', publishedAt: '2026-06-30' },
    { episodeNumber: 6, title: 'From Campus Radio to Community Building', description: 'How a tiny campus radio project grew into a community platform.', guest: 'Zoya Ahmed', guestRole: 'Campus radio founder', category: 'Student Voices', durationLabel: '33:47', durationSeconds: 2027, audioUrl: '/audio/tsc-placeholder-audio.wav', videoUrl: null, youtubeUrl: null, thumbnail: '/images/podcast/podcast-5.jpg', publishedAt: '2026-06-16' },
  ],

  events: [
    { title: 'Career Awareness Workshop', dek: 'Helping students discover careers beyond the conventional path.', description: 'Sessions include career discovery frameworks, live Q&A with professionals and a planning exercise.', date: '2026-09-18', startTime: '10:00 AM – 4:00 PM', venue: 'Seminar Hall A, Nalanda Institute ', city: 'Patna', state: 'Bihar', organizer: 'TSC Career Awareness Team ', category: 'Career', registrationDeadline: '2026-09-15', image: '/images/events/event-1.jpg', status: 'upcoming', featured: true },
    { title: "Founders' Meetup & Networking Evening", dek: 'Student founders, builders and the merely curious — one room, zero gatekeeping.', description: 'Lightning talks, speed networking and open tables for co-founder hunting.', date: '2026-09-26', startTime: '5:30 PM – 8:30 PM', venue: 'Innovation Hub,Innovation Hub', city: 'Bengaluru', state: 'Karnataka', organizer: 'E-Cell Collective', category: 'Networking', registrationDeadline: '2026-09-22', image: '/images/events/event-4.jpg', status: 'upcoming' },
    { title: 'Education Fair: Courses, Colleges & Careers', dek: 'Meet institutions, explore programmes, ask real questions.', description: 'Sessions on admissions timelines, scholarships and portfolio building.', date: '2026-09-12', startTime: '9:00 AM – 6:00 PM', venue: 'Main Auditorium,Campus Auditorium', city: 'Ranchi', state: 'Jharkhand', organizer: 'Education Collective', category: 'Education', registrationDeadline: '2026-09-10', image: '/images/campus/campus-1.jpg', status: 'upcoming' },
    { title: 'National Student Hackathon 2026', dek: 'Thirty-six hours, real problem statements, a hall full of builders.', description: 'Tracks in education, civic tech, sustainability and open innovation.', date: '2026-10-04', startTime: '8:00 AM (Day 1)', venue: 'Tech Park Block, Coastal University ', city: 'Kochi', state: 'Kerala', organizer: 'Tech Communities', category: 'Technology', registrationDeadline: '2026-09-27', image: '/images/events/event-2.jpg', status: 'upcoming', featured: true },
    { title: 'Leadership Bootcamp for Student Councils', dek: 'Governance, communication and getting things done inside institutions.', description: 'A bootcamp for student council members.', date: '2026-10-02', startTime: '9:30 AM – 5:00 PM', venue: 'Convention Centre, Sagar Public University ', city: 'Bhopal', state: 'Madhya Pradesh', organizer: 'Leadership Foundation', category: 'Leadership', registrationDeadline: '2026-09-28', image: '/images/events/event-1.jpg', status: 'upcoming' },
    { title: 'Yuva Cultural Night', dek: 'Music, theatre, poetry and dance — a stage built by students.', description: 'Open-mic warm-ups, band performances and the annual poetry slam finale.', date: '2026-10-11', startTime: '5:00 PM – 10:00 PM', venue: 'Open Air Theatre, Coastal University ', city: 'Kochi', state: 'Kerala', organizer: 'Culture Collective', category: 'Culture', registrationDeadline: '2026-10-08', image: '/images/events/event-3.jpg', status: 'upcoming' },
    { title: 'Pitch Your Idea: Student Startup Competition', dek: 'Five minutes, five slides, one idea.', description: 'Pitching workshops, a qualifying round and a final showcase.', date: '2026-10-24', startTime: '10:00 AM – 7:00 PM', venue: 'E-Cell Arena, Sunrise Engineering ', city: 'Hyderabad', state: 'Telangana', organizer: 'E-Cell Network', category: 'Entrepreneurship', registrationDeadline: '2026-10-18', image: '/images/campaign/campaign-3.jpg', status: 'upcoming' },
    { title: 'Summer Coding Sprint', dek: 'A four-week remote sprint where 200 students shipped their first projects.', description: 'This event has concluded.', date: '2026-08-15', startTime: 'Remote • Evenings', venue: 'Online', city: 'Remote', state: 'Pan-India', organizer: 'Tech Communities', category: 'Technology', registrationDeadline: '2026-08-01', image: '/images/news/news-4.jpg', status: 'past' },
  ],

  opportunities: [
    { title: 'Graduate Trainee — Operations', organization: 'BrightCart', type: 'Job', mode: 'On-site', location: 'Bengaluru, Karnataka', eligibility: '2026 graduates • Any degree', deadline: '2026-09-20', description: 'An early-career programme rotating trainees across operations with mentorship.', skills: ['Communication', 'Excel', 'Problem Solving'], featured: true },
    { title: 'Junior Content Writer', organization: 'National Media House', type: 'Job', mode: 'Hybrid', location: 'Mumbai, Maharashtra', eligibility: '0–2 years', deadline: '2026-09-30', description: 'Write explainers and campus features for a youth publication (demo listing).', skills: ['Writing', 'Editing', 'Research'] },
    { title: 'Community Manager (Early Career)', organization: 'NextGen EdTech', type: 'Job', mode: 'Remote', location: 'Remote (India)', eligibility: 'Freshers welcome', deadline: '2026-10-05', description: 'Run student communities and engagement campaigns (demo listing).', skills: ['Community', 'Social Media'] },
    { title: 'Product Design Intern', organization: 'Nimbus Labs', type: 'Internship', mode: 'Remote', location: 'Remote (India)', eligibility: 'Students • 3rd year+', deadline: '2026-09-15', description: 'A 3-month design internship shipping real UI.', skills: ['Figma', 'UI Design'], featured: true },
    { title: 'Media & Journalism Intern', organization: 'Student Newsroom', type: 'Internship', mode: 'On-site', location: 'New Delhi', eligibility: 'Students • Any stream', deadline: '2026-09-25', description: 'Cover education and youth affairs with senior editors (demo listing).', skills: ['Reporting', 'Writing'] },
    { title: 'Research Intern (Climate Policy)', organization: 'Policy Research Institute', type: 'Internship', mode: 'Remote', location: 'Remote (India)', eligibility: 'Postgraduate students', deadline: '2026-10-10', description: 'Support a demo research project on climate policy and youth participation.', skills: ['Research', 'Data Analysis'] },
