        ...
        {featured && (
          <div className="mt-12 grid gap-8 rounded-md border border-white/10 bg-white/[0.04] p-6 sm:p-8 lg:grid-cols-12">
            ...
            >
              ...
              {!hasVideo && (
                <div className="[&_span]:!text-white/90 mt-2">
              ...
              <div className="pt-2">
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-gold hover:text-white transition-colors"
                >
                  View Full Episode Details & Transcript →
                </Link>
              </div>
            </motion.div>
          </div>
