      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="card-base p-6">
          ...
          <ol className="mt-4 space-y-2">
            {SECTIONS.map((s, i) => (
              <li key={`section-toggle-${s}-${i}`} className="flex items-center justify-between gap-3 rounded-md border border-hairline bg-cream px-3.5 py-2.5">
