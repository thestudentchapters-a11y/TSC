...
export const demoArticles: Article[] = [
  {
    ...
    content: [
      ...
      'The initiative, currently live at three campuses, brings together thousands of open-access books, journals, previous-year papers and course notes in a single searchable platform built and maintained by student volunteers.',
  ...
  },
  {
    ...
    content: [
      ...
      'The project is currently in closed beta across two campuses.',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      'Across campuses this semester, one demand has surfaced again and again: transparency in evaluation.',
  ...
  },
  {
    ...
    content: [
      'The annual fest is a campus\'s biggest moment — and, traditionally, its biggest pile of waste. This year, several fest committees decided to change that.',
...
export const demoStories: Story[] = [
  {
    ...
    author: 'Meera R.', authorRole: 'TSC Stories ', campus: 'Nalanda Institute of Technology ',
    date: '2026-08-22', readingTime: 5,
    quote: { text: 'I did not start because I wanted to build a product. I started because the problem would not leave me alone.', person: 'Student innovator' },
    content: [
      'Every campus has that one student who cannot walk past a broken thing without stopping. This is a story about one of them.',
      ...
      'TSC tells these stories because the next solution-builder might be reading this in a classroom right now.',
    ],
  },
  {
    ...
    author: 'Kabir J.', authorRole: 'TSC Stories ', campus: 'Vidya Vihar Central University ',
    date: '2026-08-18', readingTime: 6,
    quote: { text: 'The classroom gave us the idea. The campus gave us our first users.', person: 'Student founder' },
    content: [
      ...
      'The startup is still early. The journey is already worth telling.',
    ],
  },
  {
    ...
    author: 'Meera R.', authorRole: 'TSC Stories ', campus: 'Coastal University of Arts & Sciences ',
    ...
    content: [
      ...
      'The lesson: a campus is not different because of its buildings. It is different because of what its students refuse to leave undone.',
    ],
  },
  {
    ...
    author: 'Ananya T.', authorRole: 'TSC Stories ', campus: 'Sagar Public University ',
    date: '2026-08-05', readingTime: 4,
    content: [
      'The first time they spoke on a mic, the voice shook. The second time, less. By the national round (national competition), the room listened.',
      ...
      'It is also a story about the people who helped: a teacher who stayed back after class, a sibling who was the first audience, a friend who never missed a practice round.',
    ],
  },
  {
    ...
    author: 'Kabir J.', authorRole: 'TSC Stories ', campus: 'Sunrise Engineering College ',
    ...
    content: [
      ...
      'Six months later, the same story has a different ending — and a completely different relationship with the word "no".',
    ],
  },
  {
    ...
    author: 'Ananya T.', authorRole: 'TSC Stories ', campus: 'Himalayan Polytechnic & Research Institute ',
    ...
    content: [
      ...
      'Today the "studio" has a real address. But the founders say the hustle was the best curriculum they ever had.',
    ],
  },
  {
    ...
    author: 'Meera R.', authorRole: 'TSC Stories ', campus: 'Vidya Vihar Central University ',
    ...
    content: [
      ...
      'This story tracks the strange, wonderful path from assignment to incorporation — including the moment the team realised their classmates were genuinely their first paying users.',
      'Their advice to other student founders is refreshingly unglamorous: finish the assignment first. Then keep going.',
    ],
  },
  {
    ...
    author: 'Kabir J.', authorRole: 'TSC Stories ', campus: 'Nalanda Institute of Technology ',
    ...
    content: [
      ...
      'This story explores how a student-run night library initiative changed how one campus studies: volunteer-managed shifts, a silence code everyone respects, and chai that appears mysteriously at midnight.',
      'Sometimes the best campus infrastructure is the kind students build themselves.',
    ],
  },
  {
    ...
    author: 'Ananya T.', authorRole: 'TSC Stories ', campus: 'Coastal University of Arts & Sciences ',
    ...
    content: [
      ...
      'The story of a culture collective that started with a nervous open mic and grew into a movement — poetry, debate, music, theatre — that gave a quiet campus its voice.',
      'The secret, the founders say, was the first five minutes rule: make the first five minutes so welcoming that nobody fears the stage.',
    ],
  },
];
...
export const demoCampuses: Campus[] = [
  {
    ...
    description: 'A campus known for its student incubator, weekend makers meets and an active research circle.',
  ...
  },
  {
    ...
    description: 'An engineering campus with a thriving hackathon culture and a student-run night library.',
  ...
  },
  {
    ...
    description: 'A demo campus celebrated for its culture collectives, debate society and waterfront campus life.',
  ...
  },
  {
    ...
    description: 'A demo campus with strong social-science research groups and a growing student leadership programme.',
  ...
  },
  {
    ...
    description: 'A polytechnic campus where media, making and mountains meet — home to a student production studio.',
  ...
  },
  {
    ...
    description: 'A demo engineering college with an active E-Cell and one of the loudest fest seasons in the region.',
...
export const demoEpisodes: PodcastEpisode[] = [
  {
    id: 'p1',
    slug: 'we-met-these-little-monks-rumtek-monastery-sikkim',
    episodeNumber: 18,
    featured: true,
    title: 'WE MET THESE LITTLE MONKS | RUMTEK MONASTERY - SIKKIM',
    description:
      'In this episode of the All India Youth Career Awareness documentary series, The Student Chapters visits Rumtek Monastery in Sikkim. We meet young monks, explore their daily routine, education, spiritual discipline, and unique life journeys tucked high in the Eastern Himalayas.',
    guest: 'Young Monks & Teachers',
    guestRole: 'Rumtek Dharma Chakra Centre, Sikkim',
    ...
    platforms: {
      youtube: 'https://www.youtube.com/watch?v=uIkqEfxUmXc',
      spotify: null,
      apple: null,
    },
    transcript: [
      '[00:00] Host: Welcome to The Student Chapters — All India Youth Career Awareness documentary series.',
      '[01:15] Rumtek Monastery: Inside the spiritual and educational journey of young monks in Sikkim.',
      '[08:40] Daily life, study schedules, discipline and Tibetan Buddhist philosophy in modern education.',
      '[18:20] Key reflections on learning, mindfulness and finding purpose.',
    ],
    demo: false,
  },
  {
    id: 'p-startup',
    slug: 'what-nobody-tells-you-about-your-first-startup',
    episodeNumber: 1,
    featured: false,
    title: 'What Nobody Tells You About Your First Startup',
    description:
      'A candid conversation with a student founder about the unglamorous middle between idea and milestone.',
    guest: 'Ishaan Verma',
    guestRole: 'Founder,Campus Innovators',
    category: 'Founder Stories',
    durationLabel: '38:12',
    date: '2026-08-20',
    image: '/images/podcast/podcast-host.jpg',
    imageAlt: 'What Nobody Tells You About Your First Startup',
    ...
    transcript: [
      '[00:00] Host: Welcome to TSC Podcast — Founder Stories.',
      '[02:10] Ishaan: The reality of building a prototype while attending college classes.',
      '[15:40] Finding your first 100 users with zero marketing budget.',
      '[28:15] Lessons from early setbacks and pivoting before graduating.',
    ],
    demo: false,
  },
  {
    id: 'p2',
    slug: 'the-gap-year-that-changed-everything',
    episodeNumber: 17,
    featured: false,
    title: 'The Gap Year That Changed Everything',
    description:
      'A student voices conversation on taking an intentional, unconventional pause — and what a year spent exploring real-world projects, community work and personal mastery taught a young creator.',
    guest: 'Riya Chatterjee',
    guestRole: 'Student & Community Builder',
    ...
    transcript: ['Full audio transcript available with episode stream.'],
    demo: false,
  },
  {
    id: 'p3',
    slug: 'breaking-into-tech-without-a-cs-degree',
    episodeNumber: 16,
    featured: false,
    title: 'Breaking Into Tech Without a CS Degree',
    description:
      'A candid career conversation exploring practical routes into modern software engineering, open source contributions and building an undeniable project portfolio from non-traditional academic backgrounds.',
    guest: 'Aman Khanna',
    guestRole: 'Software Engineer & Mentor',
    category: 'Career Conversations',
    durationLabel: '44:05',
    date: '2026-07-28',
    image: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg',
    imageAlt: 'Breaking into Tech - The Student Chapters',
    audioUrl: null,
    videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc',
    youtubeUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc',
    platforms: {
    ...
    transcript: ['Full transcript available with episode stream.'],
    demo: false,
  },
  {
    id: 'p4',
    slug: 'ideas-are-cheap-execution-is-everything',
    episodeNumber: 15,
    featured: false,
    title: 'Ideas Are Cheap. Execution Is Everything.',
    description:
      'An inspiring founder stories deep dive on moving from idea phase to shipping real products, finding early believers and overcoming early hurdles.',
    guest: 'Dr. Nandita Rao',
    guestRole: 'Educator & Innovation Mentor',
    category: 'Founder Stories',
    durationLabel: '29:58',
    date: '2026-07-14',
    image: '/images/podcast/podcast-3.jpg',
    imageAlt: 'Recording equipment for a podcast session',
    audioUrl: '/audio/tsc-placeholder-audio.wav',
    videoUrl: null,
    youtubeUrl: null,
    platforms: { youtube: null, spotify: null, apple: null },
  ...
  {
    id: 'p5',
    slug: 'studying-smart-science-over-superstition',
    episodeNumber: 14,
    featured: false,
    title: 'Studying Smart: Science Over Superstition',
    description:
      'Evidence-based cognitive science techniques for effective student learning — spaced repetition, active recall, sleep optimization and managing exam anxiety.',
    guest: 'Vikram Shetty',
    guestRole: 'Learning Science Researcher',
    category: 'Ideas & Perspectives',
    durationLabel: '36:22',
    date: '2026-06-30',
    image: '/images/podcast/podcast-4.jpg',
    imageAlt: 'A podcast studio desk with microphones and headphones',
    audioUrl: '/audio/tsc-placeholder-audio.wav',
    videoUrl: null,
    youtubeUrl: null,
    platforms: { youtube: null, spotify: null, apple: null },
  ...
  {
    id: 'p6',
    slug: 'from-campus-radio-to-community-building',
    episodeNumber: 13,
    featured: false,
    title: 'From Campus Radio to Community Building',
    description:
      'How a student initiative grew into a pan-India youth dialogue network — lessons in leadership, grassroots outreach and building creative momentum.',
    guest: 'Zoya Ahmed',
    guestRole: 'Youth Community Lead',
    category: 'Student Voices',
    durationLabel: '33:47',
    date: '2026-06-16',
    image: '/images/podcast/podcast-5.jpg',
    imageAlt: 'A young creator recording a podcast in a home studio',
    audioUrl: '/audio/tsc-placeholder-audio.wav',
    videoUrl: null,
    youtubeUrl: null,
    platforms: { youtube: null, spotify: null, apple: null },
...
export const demoEvents: TscEvent[] = [
  ...
  },
  {
    ...
    date: '2026-09-26', time: '5:30 PM – 8:30 PM', venue: 'Innovation Hub,Innovation Hub', city: 'Bengaluru', state: 'Karnataka',
    organizer: 'E-Cell Collective', category: 'Networking',
  ...
  },
  {
    ...
    date: '2026-09-12', time: '9:00 AM – 6:00 PM', venue: 'Main Auditorium,Campus Auditorium', city: 'Ranchi', state: 'Jharkhand',
    organizer: 'Education Collective', category: 'Education',
  ...
  },
  {
    ...
    organizer: 'Tech Communities', category: 'Technology',
  ...
  },
  {
    ...
    description: [
      'A bootcamp for student council members: running meetings that end in decisions, representing voices that disagree, budgeting for events, and building teams that outlast tenures.',
    ],
    date: '2026-10-02', time: '9:30 AM – 5:00 PM', venue: 'Convention Centre, Sagar Public University ', city: 'Bhopal', state: 'Madhya Pradesh',
    organizer: 'Leadership Foundation', category: 'Leadership',
  ...
  },
  {
    ...
    organizer: 'Culture Collective', category: 'Culture',
  ...
  },
  {
    ...
    organizer: 'E-Cell Network', category: 'Entrepreneurship',
  ...
  },
  {
    ...
    description: [
      'The summer sprint paired beginners with mentors and one goal: ship something real. This event has concluded — highlights and project gallery coming to TSC Stories.',
    ],
...
export const demoOpportunities: Opportunity[] = [
  {
    id: 'o1', slug: 'graduate-trainee-operations-brightcart', type: 'Job', mode: 'On-site', featured: true, active: true, title: 'Graduate Trainee — Operations', organization: 'BrightCart',
    location: 'Bengaluru, Karnataka', eligibility: '2026 graduates • Any degree',
    deadline: '2026-09-20', postedOn: '2026-08-20',
    description: 'An early-career programme rotating trainees across supply-chain, cataloguing and vendor operations, with mentorship and a structured 12-month pathway.',
    skills: ['Communication', 'Excel / Sheets', 'Problem Solving', 'Ownership'],
    applicationUrl: 'https://careers.google.com/jobs/results/',
  },
  {
    id: 'o2', slug: 'junior-content-writer-demo-media', type: 'Job', mode: 'Hybrid', featured: false, active: true, title: 'Junior Content Writer', organization: 'National Media House',
  ...
  {
    id: 'o3', slug: 'community-manager-early-career-demo-edtech', type: 'Job', mode: 'Remote', featured: false, active: true, title: 'Community Manager (Early Career)', organization: 'NextGen EdTech',
  ...
  {
    id: 'o4', slug: 'product-design-intern-nimbus-labs', type: 'Internship', mode: 'Remote', featured: true, active: true, title: 'Product Design Intern', organization: 'Nimbus Labs',
    location: 'Remote (India)', eligibility: 'Students • 3rd year+',
    deadline: '2026-09-15', postedOn: '2026-08-15',
    description: 'A 3-month design internship: ship real UI for a student-facing product with weekly design reviews and a portfolio-worthy capstone.',
    skills: ['Figma', 'UI Design', 'User Research', 'Prototyping'],
    applicationUrl: 'https://dribbble.com/jobs',
  },
  {
    id: 'o5', slug: 'media-journalism-internship-demo-newsroom', type: 'Internship', mode: 'On-site', featured: false, active: true, title: 'Media & Journalism Intern', organization: 'Student Newsroom',
  ...
  {
    id: 'o6', slug: 'research-intern-climate-policy-demo-institute', type: 'Internship', mode: 'Remote', featured: false, active: true, title: 'Research Intern (Climate Policy)', organization: 'Policy Research Institute',
...
export const flagshipCampaign: Campaign = {
  ...
  episodes: [
    { id: 'ce1', slug: 'the-doctor', episodeNumber: 1, status: 'Released', title: 'The Doctor', professional: 'Dr. A. Sharma', profession: 'Medicine & Public Health', location: 'Patna', durationLabel: '24 min', videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', image: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', imageAlt: 'The Doctor (documentary still)', description: 'A day in the life of a doctor — from OPD rushes to the quiet decisions nobody sees, and what the profession demands beyond marks.' },
    { id: 'ce2', slug: 'the-founder', episodeNumber: 2, status: 'Released', title: 'The Founder', professional: 'I. Verma', profession: 'Consumer Startup', location: 'Bengaluru', durationLabel: '31 min', videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', image: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', imageAlt: 'The Founder (documentary still)', description: 'From hostel idea to first customers — the unglamorous, honest middle of the startup journey.' },
    { id: 'ce3', slug: 'the-civil-servant', episodeNumber: 3, status: 'Coming Soon', title: 'The Civil Servant', professional: 'Civil Services Officer', profession: 'Public Administration', location: 'Delhi', durationLabel: '28 min', videoUrl: null, image: '/images/hero/hero-workshop.jpg', imageAlt: 'A public administrator addressing a gathering (documentary still)', description: 'Beyond the exam mythology — what the work actually is, and who it truly suits.' },
    { id: 'ce4', slug: 'the-creator', episodeNumber: 4, status: 'Coming Soon', title: 'The Creator', professional: 'Digital Creator', profession: 'Media & Content', location: 'Mumbai', durationLabel: '26 min', videoUrl: null, image: '/images/hero/hero-fest.jpg', imageAlt: 'A creator filming at a live event (documentary still)', description: 'Cameras, clients and consistency — the business behind "just posting".' },
    { id: 'ce5', slug: 'the-engineer', episodeNumber: 5, status: 'Coming Soon', title: 'The Engineer', professional: 'Aerospace Engineer', profession: 'Aerospace & Manufacturing', location: 'Hyderabad', durationLabel: '29 min', videoUrl: null, image: '/images/stories/story-3.jpg', imageAlt: 'An engineer working on a technical prototype (documentary still)', description: 'Machines, patience and precision — engineering beyond the placement-package version.' },
    { id: 'ce6', slug: 'the-educator', episodeNumber: 6, status: 'Coming Soon', title: 'The Educator', professional: 'Academic Educator', profession: 'Teaching & Research', location: 'Kochi', durationLabel: '25 min', videoUrl: null, image: '/images/campaign/campaign-1.jpg', imageAlt: 'An educator in a classroom setting (documentary still)', description: 'Why the best teachers chose the classroom — and what keeps them there.' },
  ],
};
