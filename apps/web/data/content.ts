...
export const demoEpisodes: PodcastEpisode[] = [
  ...
  },
  {
    ...
    description:
      'A candid conversation with a student founder about the unglamorous middle between idea and milestone. [Demo episode.]',
    guest: 'Ishaan Verma',
    guestRole: 'Founder, [Demo Startup]',
...
export const flagshipCampaign: Campaign = {
  ...
  episodes: [
    { id: 'ce1', slug: 'the-doctor', episodeNumber: 1, status: 'Released', title: 'The Doctor', professional: 'Dr. A. Sharma [Demo]', profession: 'Medicine & Public Health', location: 'Patna', durationLabel: '24 min', videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', image: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', imageAlt: 'The Doctor (documentary still)', description: 'A day in the life of a doctor (demo episode) — from OPD rushes to the quiet decisions nobody sees, and what the profession demands beyond marks.' },
    { id: 'ce2', slug: 'the-founder', episodeNumber: 2, status: 'Released', title: 'The Founder', professional: 'I. Verma [Demo]', profession: 'Consumer Startup', location: 'Bengaluru', durationLabel: '31 min', videoUrl: 'https://www.youtube.com/watch?v=uIkqEfxUmXc', image: 'https://img.youtube.com/vi/uIkqEfxUmXc/hqdefault.jpg', imageAlt: 'The Founder (documentary still)', description: 'From hostel idea to first customers (demo episode) — the unglamorous, honest middle of the startup journey.' },
    { id: 'ce3', slug: 'the-civil-servant', episodeNumber: 3, status: 'Coming Soon', title: 'The Civil Servant', professional: '[Demo Officer]', profession: 'Public Administration', location: 'Delhi', durationLabel: '28 min', videoUrl: null, image: '/images/hero/hero-workshop.jpg', imageAlt: 'A public administrator addressing a gathering (documentary still)', description: 'Beyond the exam mythology (demo episode) — what the work actually is, and who it truly suits.' },
    { id: 'ce4', slug: 'the-creator', episodeNumber: 4, status: 'Coming Soon', title: 'The Creator', professional: '[Demo Creator]', profession: 'Media & Content', location: 'Mumbai', durationLabel: '26 min', videoUrl: null, image: '/images/hero/hero-fest.jpg', imageAlt: 'A creator filming at a live event (documentary still)', description: 'Cameras, clients and consistency (demo episode) — the business behind "just posting".' },
    { id: 'ce5', slug: 'the-engineer', episodeNumber: 5, status: 'Coming Soon', title: 'The Engineer', professional: '[Demo Engineer]', profession: 'Aerospace & Manufacturing', location: 'Hyderabad', durationLabel: '29 min', videoUrl: null, image: '/images/stories/story-3.jpg', imageAlt: 'An engineer working on a technical prototype (documentary still)', description: 'Machines, patience and precision (demo episode) — engineering beyond the placement-package version.' },
    { id: 'ce6', slug: 'the-educator', episodeNumber: 6, status: 'Coming Soon', title: 'The Educator', professional: '[Demo Educator]', profession: 'Teaching & Research', location: 'Kochi', durationLabel: '25 min', videoUrl: null, image: '/images/campaign/campaign-1.jpg', imageAlt: 'An educator in a classroom setting (documentary still)', description: 'Why the best teachers (demo episode) chose the classroom — and what keeps them there.' },
  ],
};
