...
export const collections: Record<string, CollectionDef> = {
  ...
  podcasts: {
    ...
    fields: [
      ...
      { name: 'audioUrl', label: 'Audio URL', type: 'text', width: 'half', hint: 'Audio stream link (MP3/WAV/RSS). Provide EITHER Audio URL OR Video URL, not both.' },
      { name: 'youtubeUrl', label: 'Video URL', type: 'text', width: 'half', hint: 'Video URL or app embed link. Provide EITHER Video URL OR Audio URL, not both.' },
      { name: 'image', label: 'Thumbnail Image URL', type: 'image', width: 'half', hint: 'Custom cover image or video thumbnail URL.' },
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'featured', label: 'Featured', type: 'checkbox', width: 'half' },
    ],
  },
  ...
  campaigns: {
    key: 'campaign-episodes', title: 'Documentary Series Episodes', singular: 'Documentary Episode', icon: Rocket, seedKey: 'campaignEpisodes',
    description: 'All India Career Awareness Youth Documentary Series episodes and video cards.',
    columns: [
      { name: 'episodeNumber', label: 'Ep #' },
      { name: 'title', label: 'Title' },
    ...
    fields: [
      { name: 'videoUrl', label: 'Documentary Video URL', type: 'text', width: 'full', hint: 'Paste video link (YouTube, Vimeo, app URL). Thumbnail will be extracted automatically.' },
      { name: 'title', label: 'Documentary Title', type: 'text', required: true, width: 'half' },
      { name: 'episodeNumber', label: 'Episode Number', type: 'number', required: true, width: 'half' },
      { name: 'slug', label: 'Slug', type: 'text', width: 'half', hint: 'Auto-generated from title if left blank' },
      { name: 'professional', label: 'Featured Professional', type: 'text', width: 'half' },
      { name: 'profession', label: 'Profession / Career Field', type: 'text', width: 'half' },
      { name: 'location', label: 'Filming Location', type: 'text', width: 'half' },
      { name: 'durationLabel', label: 'Duration (e.g. 24 min)', type: 'text', width: 'half' },
      { name: 'status', label: 'Status', type: 'select', options: ['Released', 'Coming Soon'], required: true, width: 'half' },
      { name: 'image', label: 'Thumbnail Image URL', type: 'image', width: 'half', hint: 'Auto-extracted from video URL or upload custom thumbnail' },
      { name: 'description', label: 'Description / Synopsis', type: 'textarea' },
    ],
    filters: { key: 'status', label: 'Status', options: ['Released', 'Coming Soon'] },
  },
  members: {
  ...
  'campus-submissions': {
    ...
    fields: [
      ...
      { name: 'type', label: 'Type', type: 'select', options: ['news', 'story'], width: 'half' },
      { name: 'name', label: 'Submitter', type: 'text', width: 'half' },
      { name: 'email', label: 'Email', type: 'text', width: 'half' },
      { name: 'campus', label: 'Associated Campus', type: 'text', width: 'half' },
      { name: 'college', label: 'College / Institution', type: 'text', width: 'half' },
      { name: 'category', label: 'Category', type: 'text', width: 'half' },
      { name: 'summary', label: 'Summary / Content', type: 'textarea' },
      { name: 'status', label: 'Status', type: 'select', options: ['pending', 'under review', 'approved', 'rejected'], width: 'half' },
    ],
    filters: { key: 'status', label: 'Status', options: ['pending', 'under review', 'approved', 'rejected'] },
  },
