...
export const collections: Record<string, CollectionDef> = {
  ...
  podcasts: {
    ...
    fields: [
      ...
      { name: 'youtubeUrl', label: 'YouTube Video URL', type: 'text', width: 'half', hint: 'If provided, embedded directly as an interactive video player and its YouTube thumbnail is automatically used across the website.' },
      { name: 'image', label: 'Custom Thumbnail URL', type: 'image', width: 'half', hint: 'Optional when YouTube URL is provided (YouTube thumbnail is automatically used instead).' },
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'featured', label: 'Featured', type: 'checkbox', width: 'half' },
    ],
  },
