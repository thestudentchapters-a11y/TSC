...
export const collections: Record<string, CollectionDef> = {
  ...
  podcasts: {
    ...
    fields: [
      ...
      { name: 'youtubeUrl', label: 'Video / App Embed URL', type: 'text', width: 'half', hint: 'Paste any YouTube, Vimeo, direct video (.mp4/.webm), or external web app URL to embed directly in the interactive player.' },
